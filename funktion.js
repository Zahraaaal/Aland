...
function antwort(antwort) {
    ...
    if (antwort === 'Ja') {
        ...
        ausgabeElement.innerHTML = 'Bitte erneut versuchen!(nein ist keine Option)';
...
function starteKonfetti() {
    confetti({
        ...
        startVelocity: 30,  // Startgeschwindigkeit
        spread: 360,        // Streuung (Richtung in Grad)
        origin: { x: 0.5, y: 0.5 }, // Startposition (zentriert)
    });
}

// Starte das Konfetti, wenn die Seite geladen wird
